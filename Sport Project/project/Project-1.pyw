...
def specialized_variables():
    if entry_weigth.get()==''or entry_height.get()==''or entry_age.get()==''or entry_purpose_fat.get()=='':
        messagebox.showwarning("!ناقص","لطفا فرم را کامل کنيد")
    else:
...
win.iconphoto(False, ImageTk.PhotoImage(file='icons8-gym-60.png'))


filename = ImageTk.PhotoImage(file = 'sports-png-30297.png')
