...
win.maxsize(590, 300)
win.minsize(590, 300)
win.iconphoto(False, PhotoImage(file='icons8-gym-60.png'))

canvas_photo = Canvas(win, bg="blue", height=500, width=300)
filename = PhotoImage(file = 'sports-png-30297.png')
